# Generated by Django 3.1.8 on 2021-05-21 10:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_ru', models.CharField(max_length=200, verbose_name='Название на русском языке')),
                ...
                ('image', models.ImageField(upload_to='pokemons_images', verbose_name='Изображение')),
                ('description', models.TextField(verbose_name='Описание')),
                ('previous_evolution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='next_evolution', to='pokemon_entities.pokemon', verbose_name='Родитель')),
            ],
        ),
        migrations.CreateModel(
            name='PokemonEntity',
